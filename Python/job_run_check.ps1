...
$servers = @(
    @{server = "192.168.20.159"; username = "sa"; password = "infodev"},
...
$columns = @("ServerName", "Dbname", "JobName", "Is_Enabled", "Last_Run_Outcome", "Last_Run_Date", "Last_Run_Time","Run_Duration","Job_History")
    ...
    try {
        ...
        while ($reader.Read()) {
            ...
            $jobDetails = @{
                ...
                Run_Duration    = $reader["Run_Duration"]
                Job_History     = $reader["message"]
            }
            $row = $all_jobs.NewRow()
...
$outputDirectory = "C:/Users/shirash.shrestha/Documents/Python/SQL_Server_Jobs"
